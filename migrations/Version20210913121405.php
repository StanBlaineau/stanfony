 ...
 */
final class Version20210913121405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD email VARCHAR(255) NOT NULL; CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email);');
    }
